...
class App(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("GenAI & AI系統")
        ...
        pixmap = QPixmap(img.scaled(240, 240, Qt.AspectRatioMode.KeepAspectRatio))
    ...
    def show_message_and_hide_button(self):
        ...
        self.electric_figure_label_path.setVisible(False)
        self.heat_figure_label_path.setVisible(False)
        self.obj_val_trend_figure.setVisible(False)  # Hide the trend plot
