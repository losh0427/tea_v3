...
def global_optimization(exec_path = "C:/Users/USER/Desktop/tea/3/Tea_second/Code_v3/Full_Flow/", dataset_name = "data_1004", round_num = 300, heat_coeff = 100000, item_coeff = 0.95
                        , input_bound = [ [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [0, 360], ["2.0", "2.45", "3.0"], [500, 900], [-100, 100], [-100, 100], [-100, 100], [-100, 100]]
    ...
    for i in range(300):
        ...
        model = Surrogate_model(input_bound, heat_coeff, item_coeff)
        ...
        for num in range(len(parameters)):            
            ...
            Output_Handler_superposition(output_number-3,output_path,DATA_PATH,parameters[num], heat_coeff, item_coeff)
